...
Откуда-то на почту прилетела просьба перевести, ну вот перевел, по старой памяти перевода.
...
Расширение проводника, добавляет в Свойства файла, содержащего иконки, вкладку
"Значки", на ней можно просмотреть иконки, узнать их номер, извлечь и сохранить.
Значки можно найти во многих типах файлов Windows, например, помимо прочего,
файлы следующих типов: exe, dll, ocx, cpl, ico, icl и т.д.
Бесплатная. Перевод в комплекте.
...
[Сайт программы](https://www.videohelp.com/software/gMKVExtractGUI)  
  
Простой и удобный в работе графический интерфейс для MKVToolnix. C его помощью вы сможете извлекать треки, вложения и теги из файлов форматов matroska (MKV и т.д.).
