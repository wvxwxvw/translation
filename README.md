...
Портативный легкий менеджер буфера обмена, с возможностью форматировать текст в буфере и многими др. функциями. Очень гибкий и легко настраиваемый. Меню с сохраненными фразами и историей буфера доступно по горячим клавишам и по значку в трее. Вид меню настраивается - цвет, шрифт, фон, прозрачность, состав, поведение и т.п.  
